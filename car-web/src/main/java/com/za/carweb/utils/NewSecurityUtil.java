...
/**
 * @author 2020/4/9 0009 16:22
 * @auther YangShengFu
 * 新支付平台解密
 */
@Slf4j
public class NewSecurityUtil {

    private static java.util.logging.Logger logger = (Logger) LoggerFactory.getLogger(ExcelUtils.class);
...
//			a = URLDecoder.decode(a, "utf-8");
            ...
            Map<String, String> map = NewSecurityUtil.getValueMap(JSONObject.parseObject(json.toString(), Feature.valueOf("")));
            String sign_msg = NewSecurityUtil.encryMD5(map, "abc123");
